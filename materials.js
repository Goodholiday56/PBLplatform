...
const lessonMaterials = {
  ...
  '1_0': { // 课时1：城市探索 — 定位亦庄的空间优势
    showMap: true,
    activities: [
      { time:'15分钟', title:'活动一：空间定位探究', type:'map-locate', desc:'在交互地图中定位亦庄，测算与天安门的距离与通勤时长，对比亦庄与市中心、海淀、朝阳的空间差异。观察卫星影像特征（建筑密度、道路宽度、绿化空间），小组讨论赛事选址亦庄而非市中心的三个核心原因。',
        resource:'北京行政区划图、亦庄卫星影像',
        task:'完成《亦庄空间定位分析表》' },
      { time:'20分钟', title:'活动二：赛道解码分析', type:'route-decode', desc:'观察官方赛事路线图，标注起点（南海子公园）、途经节点（科创街区）与终点。分析"生态公园→科创园区"的路线布局逻辑，解读从自然生态到科创产业的城市空间叙事。小组为赛道创意命名并撰写寓意解读。',
        resource:'赛事路线图、地铁线路图、南海子公园与科创园区实景图',
        task:'完成《赛事路线空间叙事图》' },
      { time:'10分钟', title:'活动三：课堂展示与互评', type:'present', desc:'小组代表展示空间定位分析成果和赛道命名创意，全班互评。教师从地图标注准确性、分析逻辑性、叙事创意性三个维度综合评价。',
        resource:'',
  ...
  '1_1': { // 课时2：产业寻链 — 解读亦庄的科技生态
    activities: [
      { time:'18分钟', title:'活动一：机器人产业地图绘制', type:'research-map', desc:'分组调研小米机器人、优必选、宇树科技、荣耀等亦庄代表性企业。从主营业务、核心技术优势、产业链归属三个维度梳理企业信息。按"核心零部件→整机制造→系统集成→应用服务"四层分类，绘制《亦庄机器人产业生态图》，标注产业链上下游关联关系。',
        resource:'亦庄科创企业名录、产业空间布局图、机器人产业发展报告摘要',
        task:'绘制《亦庄机器人产业生态图》（含四层产业链+上下游关联标注）' },
      { time:'17分钟', title:'活动二：产业选址论证', type:'argument', desc:'思想实验：假设赛事选址在普通城区（无产业集聚）vs 实际选址亦庄，从技术测试、设备保障、人才支撑、产业氛围四个维度对比分析。理解产业集群对赛事的全方位支撑作用。对比科技发布会与大众马拉松的传播差异，理解赛事的城市产业宣传价值。',
        resource:'',
  ...
  '1_2': { // 课时3：政策解析 — 理解赛事的社会价值
    activities: [
      { time:'15分钟', title:'活动一：政策探秘解读', type:'policy-study', desc:'小组研读《人形机器人创新发展指导意见》等国家政策文件摘要，提炼"新质生产力""创新驱动""科技强国"等核心关键词，构建政策关键词云。小组探究国家为什么要扶持机器人赛事——赛事落地和实验室建设有什么不同？为什么说"赛事是最真实的检验"？',
        resource:'《人形机器人创新发展指导意见》摘要、国家人工智能产业政策文件',
        task:'构建政策关键词云，总结"以赛促研、以赛促产、以赛促用"的政策支撑逻辑。' },
      { time:'20分钟', title:'活动二：科技传播对比与科普创作', type:'compare-create', desc:'对比观看科技部新闻发布会视频与亦庄赛事现场集锦视频，从受众范围、参与感、传播效果、公众认知四个维度完成对比分析表。角色扮演"赛事规划师"，面对公众撰写150字通俗科普解说词，用最简洁的语言讲清楚"为什么这个赛事值得关注"。',
        resource:'赛事宣传视频、科技发布会对比素材、科普解说词模板',
  ...
  '2_0': { // 课时1：智感启程 — 解密机器人的奔跑系统
    activities: [
      { time:'10分钟', title:'活动一：赛事现象观察与问题记录', type:'observe', desc:'观看机器人赛事失误片段集锦（摔倒、减速、姿态失衡），小组记录至少5个具体问题现象。从信息技术（感知与决策出了问题？）和物理（平衡被打破？受力不均？能耗不足？）两个维度初步分析每个问题的成因，完成《问题记录表》。',
        resource:'机器人赛事失误片段集锦（摔倒/减速/失衡）',
        task:'完成《问题记录表》，至少记录5个问题现象并尝试从信息/物理双维度分析成因。' },
      { time:'25分钟', title:'活动二：系统结构拆解', type:'system-deconstruct', desc:'教师讲解机器人"环境感知→数据处理→智能决策→运动执行"的完整运行流程。深入解析：①重心平衡（ZMP理论+姿态控制）②能量转化（电池放电→电机扭矩→地面反作用力）③散热控制（液冷循环→维持最佳工作温度）。对比真实机器人设计方案，梳理各系统对稳定奔跑的影响权重。',
        resource:'环境感知→决策→运动执行系统流程图、真实机器人设计方案对比资料',
        task:'完成机器人系统结构拆解图，标注四大核心系统的输入/输出关系。' },
      { time:'10分钟', title:'活动三：人机仿生对比', type:'compare', desc:'对照人体跑步：眼睛看路→大脑判断→肌肉执行→心跳供能→出汗散热。完成人机运动机制对照表，分析机器人仿生设计思路（哪些学人、哪些超越人、哪些远不如人）。核心洞察：机器人不是"像人一样跑"，而是"用人理解的物理原理，以机器的方式跑"。',
        resource:'人机仿生对照表模板',
  ...
  '2_1': { // 课时2：竞速评测 — 评选最佳半马机器人
    activities: [
      { time:'20分钟', title:'活动一：评价标准搭建', type:'framework-build', desc:'分享课后优化思路，教师引导认知"局部最优≠整体最优"的工程权衡思维——例如速度↑→能耗↑→散热压力↑→可能热降频→实际速度反而↓。师生共同搭建五维评价框架：信息决策、运动执行、系统稳定、持续运行、模块协同。每个维度分配1-5分权重。',
        resource:'五维评价框架模板',
        task:'完成五维评价框架搭建，为每个维度撰写具体评分标准（1-5分描述）。' },
      { time:'25分钟', title:'活动二：机器人方案多维评测', type:'evaluate', desc:'分组观看荣耀"闪电"、天工Ultra、宇树H1等不同参赛机器人的比赛视频片段，依托自建五维框架多维度分析各机型的优势与短板，完成《机器人评价记录表》。全班交流对比结论，重点讨论：为什么最快的机器人（闪电，50分26秒）和最稳的机器人（天工Ultra，1h15min）在不同维度上得分差异如此之大？',
        resource:'不同参赛机器人型号视频与参数对比资料',
  ...
  '2_2': { // 课时3：未来竞创 — 打造半马冠军机器人
    activities: [
      { time:'5分钟', title:'活动一：知识回顾与任务导入', type:'review', desc:'快速回顾机器人五大核心运行系统与五维评价标准。梳理"速度↑→散热↑""稳定性↑→速度可能↓""轻量化↑→刚度可能↓"等核心工程制衡关系。明确本课任务：在给定约束条件下，设计一台适配亦庄半马的参赛机器人方案。',
        resource:'',
        task:'回顾知识框架，建立"多系统协同+多维约束"的设计思维。' },
      { time:'25分钟', title:'活动二：机器人创新设计', type:'design', desc:'小组围绕感知、决策、运动控制、能源、散热五大核心系统，结合赛道实际环境特征（平地、8%坡道、锐角弯、石板路面、3-5级侧风），设计一台适配半程马拉松的完整机器人方案。要求：绘制设计图（含系统标注）、撰写设计说明（含关键参数与多维权衡论证）、说明设计在"稳定性-续航-竞速"三角中的定位。',
        resource:'机器人设计图模板（含系统标注规范）、赛道环境特征数据表',
        task:'绘制机器人设计图+撰写设计说明（含系统参数与多维权衡论证）。' },
      { time:'15分钟', title:'活动三：成果展示与互评', type:'present', desc:'各小组以"机器人设计发布会"形式展示方案（3分钟），阐述设计思路、核心创新点与多维权衡哲学。全班依托五维评价框架开展结构化互评（每组收到至少2份反馈）。教师汇总互评意见，给出优化建议。',
        resource:'五维评价框架（复用）',
  ...
  '3_0': { // 课时1：数据起跑 — 建立赛事分析框架
    activities: [
      { time:'13分钟', title:'活动一：问题框架搭建', type:'framework-build', desc:'观看赛事数据回顾素材，聚焦各机型完赛表现差异（最快50分26秒 vs 未完赛 vs DNF）。引导学生将影响机器人表现的因素系统归类为四维：①运动指标（速度/配速/步态/分段）②力学因素（重心/摩擦/坡度）③环境因素（温度/风速/路面）④工程因素（能源/散热/控制）。形成结构化问题清单。',
        resource:'赛事运动数据表、赛事回顾视频素材',
        task:'完成结构化问题清单，将影响因素归类到四个维度。' },
      { time:'25分钟', title:'活动二：数据计算与可视化', type:'data-calc', desc:'依托2026赛事真实数据，完成以下核心指标计算：①平均速度=21.0975km÷完赛时间 ②配速=完赛时间÷21.0975 ③分段速度变化率。小组使用给定数据制作机器人赛事表现对比图表（柱状图/折线图均可），结合数据提炼差异化结论。',
        resource:'赛事真实数据表（各机型速度/配速/步态/分段计时）、Excel数据分析入门指南',
  ...
  '3_1': { // 课时2：原理分析 — 解释机器人表现差异
    activities: [
      { time:'17分钟', title:'活动一：力学归因分析', type:'physics-analysis', desc:'回顾上一课时数据差异发现，选取4个典型故障案例：①弯道摔倒（宇树H1）②上坡失速③步态发散（石板路面）④热保护停车。结合重心高度、摩擦力(f=μN)、坡度角(θ)、侧向风力(F=0.5ρv²CA)等物理概念，对每个案例完成"现象→力学原理→工程原因→改进方案"的完整归因链。绘制受力示意图，填写原因说明卡。',
        resource:'力学分析模板与受力示意图绘制规范、典型故障案例视频/数据',
        task:'完成至少2个故障案例的完整力学归因分析（含受力示意图+因果说明卡）。' },
      { time:'20分钟', title:'活动二：环境研判与赛事决策', type:'env-assessment', desc:'结合赛事当日环境数据（温度15-22℃、风速3-5级、湿度40-60%、路面温度25-35℃），研判不同环境条件对各类机器人的差异化影响：高温→电机降功率；强侧风→倾覆力矩增大；路面高温→轮胎/足底摩擦系数变化。以"赛事组织者"身份，讨论：什么天气条件下该考虑延期？路线怎样优化以降低风险？补给站/降温区如何设置？',
        resource:'赛事当日环境数据（温度/风速/路面湿度/坡度分布）、赛道环境数据表',
  ...
  '3_2': { // 课时3：综合整理 — 形成完赛优化报告
    activities: [
      { time:'17分钟', title:'活动一：工程策略设计', type:'strategy-design', desc:'深入理解四大核心制衡关系：速度↔能耗（正相关）、速度↔散热（正相关，指数级）、稳定性↔速度（部分负相关）、轻量化↔刚度（负相关）。聚焦"你要什么"vs"你愿意牺牲什么"的工程取舍哲学。结合赛道具体环境数据，分组设计两套差异化参赛策略：A.保守完赛优先（目标完赛率98%）B.竞速冲刺优先（目标排名，接受60%完赛率）。绘制策略对比矩阵。',
        resource:'工程制衡关系矩阵模板、赛道环境数据',
        task:'设计至少2套差异化参赛策略方案，绘制策略对比矩阵。' },
      { time:'28分钟', title:'活动二：综合报告撰写与成果展示', type:'report-write', desc:'学生自主设置赛事评价指标及权重（至少5个指标），搭建专属评价模型。整合全部探究成果：数据分析(课时1)→力学归因(课时2)→环境研判(课时2)→工程策略(本课时)，撰写《机器人参赛综合评估报告》。报告结构：摘要→数据分析→原理归因→环境研判→策略设计→建议与展望。小组完成3分钟成果展示，开展自评与互评。',
        resource:'赛事综合评估报告模板（含评价指标设置指南）、数据分析/力学归因/环境研判前期成果',
  ...
  '4_0': { // 课时1：传播初探 — 拆解科技故事的表达方式
    activities: [
      { time:'5分钟', title:'活动一：情境导入', type:'intro', desc:'播放赛事精彩短视频集锦（机器人起跑、弯道超车、冲线瞬间），引导学生思考：为什么要向公众传播科技赛事？不只是"报道新闻"，更是"让科技被看见"。确立"科技赛事传播者"的角色定位——你的任务是把硬核科技变成大众能懂、想看、愿意分享的故事。',
        resource:'赛事精彩短视频集锦',
        task:'思考并写下：一个好的科技传播作品最重要的三个特质是什么？' },
      { time:'15分钟', title:'活动二：科技新闻拆解', type:'news-deconstruct', desc:'精读官方赛事报道原文，用"荧光笔标注法"完成：①标注5W1H六要素（Who/What/When/Where/Why/How）②圈出至少5个专业术语③在页边写通俗化改写建议。学习新闻五段式结构（标题→导语→主体→背景→结语），理解"倒金字塔"写作原则：最重要的信息放最前面。',
        resource:'官方赛事科技报道原文、5W1H拆解模板',
        task:'完成新闻五段式结构拆解，用5W1H标注官方报道原文。标注至少5个专业术语并写通俗化改写。' },
      { time:'15分钟', title:'活动三：媒体对比分析', type:'media-compare', desc:'对比阅读同一赛事的三方报道：官方媒体（人民日报/新华社）、自媒体（科技博主/抖音文案）、英文外媒（BBC/TechCrunch摘要）。从报道角度、信息准确性、语言可读性、受众适配度四个维度完成对比分析。培养批判性信息思维：不同媒体为什么"讲法"不一样？谁的报道最可信？谁的报道最好看？',
        resource:'官媒/自媒体/英文外媒三方报道对照材料',
        task:'完成三方媒体四维对比分析表。课后拟定个人作品创作大纲。' },
      { time:'5分钟', title:'活动四：创作任务选型', type:'task-select', desc:'介绍三类差异化创作方向：①科普海报设计【基础组】②新闻报道+英文简介【提升组】③短视频脚本+AI配图【挑战组】。学生根据个人兴趣和特长自主选择创作方向，确定创作主题（建议围绕赛事的一个具体角度深入，而非泛泛介绍）。',
        resource:'三类创作任务的详细要求与评价标准',
  ...
  '4_1': { // 课时2：创意工坊 — 完成科技传播作品初稿
    activities: [
      { time:'8分钟', title:'活动一：工具与支架讲解', type:'tool-demo', desc:'回顾科技传播核心技巧。针对三类创作任务分别讲解：①海报设计——版面构图（三分法）、配色方案（主色+辅色+强调色）、字体层级（标题>副标题>正文>标注）②新闻写作——标题技巧、导语打磨、段落逻辑、引语使用③脚本创作——分镜设计（开头3秒抓注意力→中间45秒核心内容→结尾15秒总结升华）。演示AI工具（文案润色/英文翻译/合规检查）的合规应用流程。',
        resource:'科普海报设计规范、短视频脚本分镜模板、AI工具使用指南',
        task:'掌握AI工具的合规应用方法：先自己完成→AI辅助优化→对比修改→决定采纳哪些→标注"AI辅助创作"。' },
      { time:'27分钟', title:'活动二：作品初稿创作', type:'create', desc:'学生自主开展创作。基础组完成科普海报设计（推荐Canva/PPT/手绘+扫描），提升组完成中文新闻报道800-1000字+英文简介150-200词，挑战组完成短视频脚本60-90秒+AI配图提示词。教师巡视并针对性答疑：帮助有畏难情绪的学生拆解任务、指导专业术语通俗化转化（类比法/场景法/分层法）。',
        resource:'三类创作任务的详细支架与模板',
        task:'完成科技传播作品初稿（科普海报/新闻报道+英文简介/短视频脚本 三选一）。' },
      { time:'5分钟', title:'活动三：初稿分享与反思', type:'share-reflect', desc:'将作品初稿上传至班级共享平台（本课使用学习反思区），每位学生简要阐述作品的核心传播主旨与预期受众。填写创作日志：①创作中最满意的1个亮点②目前最大的1个困惑③下一步最想优化的1个方向。',
        resource:'创作日志模板',
  ...
  '4_2': { // 课时3：发布迭代 — 展示并优化科技传播作品
    activities: [
      { time:'12分钟', title:'活动一：结构化同伴互评', type:'peer-review', desc:'学生依托作品评价量规——准确性（科技事实无误+来源清晰）、清晰度（逻辑通顺+层次分明+通俗易懂）、创造性（形式新颖+独特视角）、规范性（格式+引用+语言规范）——互评同学作品。要求：①给出至少2个具体优点（不是"挺好的"而是"第三段的数据对比让读者直观感受到进步"）②给出至少2条可落地修改建议。一对一交流评分依据。',
        resource:'作品评价量规（准确性/清晰度/创造性/规范性四维）',
        task:'完成至少2位同学作品的结构化互评（优点+修改建议+评分）。' },
      { time:'10分钟', title:'活动二：人机创作对比', type:'human-ai-compare', desc:'教师现场使用AI工具（智谱清言GLM-4-Flash）生成与本次创作主题相同的同款科普作品。学生小组对比分析：①人工作品哪里比AI好？（创意独特性、情感深度、真实体验感）②AI作品哪里比人强？（表达效率、语言流畅度、广度覆盖）③怎样让人和AI各取所长？深化对AI工具"辅助价值vs局限性"的认知。',
        resource:'AI生成同主题科普作品、对比分析框架表',
        task:'完成人机创作对比分析表：总结AI的3个优势+3个局限；提炼人工作品的3个不可替代的价值。' },
      { time:'16分钟', title:'活动三：作品迭代与模拟发布会', type:'iterate-present', desc:'学生结合同伴互评反馈+人机对比洞察，完成作品第二稿迭代优化。各组代表开展2分钟"模拟发布会"展示最终作品，回应现场提问。锻炼临场表达与公众沟通能力——"最好的科技传播者不是最懂技术的人，而是最能让别人懂技术的人"。',
        resource:'作品第二稿修改指南',
        task:'提交科技传播作品终稿+英文简介（如适用）。' },
      { time:'2分钟', title:'活动四：课末学习反思', type:'reflect', desc:'学生填写个人学习日志：①本次创作中我独立完成得最好的部分是……②AI工具在哪一步帮了我最大的忙？③如果再做一次，我会在哪个环节花更多时间？④我对"AI辅助、人工原创"的理解是什么？',
        resource:'个人学习日志模板',
...
function getHomeworkHTML(courseId, lessonIdx) {
  const mat = lessonMaterials[courseId + '_' + lessonIdx];
  const hw = mat ? mat.homework : '';
  if (!hw) return '';
...
function initLeafletMap(mapId) {
  ...
  // 延迟 invalidateSize 解决 flex 容器初始化尺寸问题
...
function renderMaterials(moduleId, lessonIdx, published, isTeacher) {
  ...
  // 教学活动（按教学流程排列）
  if (mat.activities && mat.activities.length) {
    html += `<div class="mat-block">
      <div class="mat-label">📋 教学活动流程</div>`;
    if (isTeacher) {
      const allPub = mat.activities.every((_, i) => published.includes(i));
      const anyPub = published.length > 0;
      html += `<div class="teacher-toolbar">
        <span class="toolbar-hint">已发布 ${published.length}/${mat.activities.length} 个活动</span>
        <button class="btn-sm ghost" onclick="publishAll('${key}', ${mat.activities.length})">${allPub ? '全部取消' : '发布全部'}</button>
        ${anyPub ? `<button class="btn-sm ghost" onclick="unpublishAll('${key}')">全部取消</button>` : ''}
      </div>`;
    }
    html += `<div class="framework">`;
    mat.activities.forEach((act, i) => {
  ...
  if (mat.systemsDiagram && mat.systemsDiagram.length) {
    ...
    mat.systemsDiagram.forEach(sys => {
      html += `
    ...
    html += `<div class="mat-block">
      ...
      <div style="overflow-x:auto;">
        <table class="mat-table">
          <thead><tr>${mat.bionicTable.headers.map(h => `<th>${h}</th>`).join('')}</tr></thead>
          <tbody>${mat.bionicTable.rows.map(row =>
            `<tr>${row.map((cell, i) => i === 0 ? `<td class="val">${cell}</td>` : `<td>${cell}</td>`).join('')}</tr>`
          ).join('')}</tbody>
        </table>
      </div>
    </div>`;
  ...
  if (mat.evalFramework && mat.evalFramework.length) {
    html += `<div class="mat-block">
      ...
      <div class="framework">`;
    mat.evalFramework.forEach(item => {
      html += `
  ...
  ['robotCompare','compareTable','raceDataTable','compareMedia'].forEach(prop => {
    if (mat[prop] && mat[prop].rows) {
      html += `<div class="mat-block">
        ...
        <div style="overflow-x:auto;">
          <table class="mat-table">
            <thead><tr>${mat[prop].headers.map(h => `<th>${h}</th>`).join('')}</tr></thead>
            <tbody>${mat[prop].rows.map(row =>
              `<tr>${row.map((cell, i) => i === 0 ? `<td class="val">${cell}</td>` : `<td>${cell}</td>`).join('')}</tr>`
            ).join('')}</tbody>
          </table>
        </div>
  ...
  if (mat.analysisFramework && mat.analysisFramework.length) {
    html += `<div class="mat-block">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">`;
    mat.analysisFramework.forEach(item => {
      html += `
  ...
  if (mat.chainFramework && mat.chainFramework.layers) {
    ...
    mat.chainFramework.layers.forEach((layer, i) => {
      html += `
  ...
  if (mat.policyTimeline && mat.policyTimeline.length) {
    html += `<div class="mat-block">
      ...
      <div style="display:flex;flex-direction:column;gap:8px;">`;
    mat.policyTimeline.forEach((item, i) => {
      html += `
  ...
  if (mat.designParams && mat.designParams.rows) {
    html += `<div class="mat-block">
      ...
      <div style="overflow-x:auto;">
        <table class="mat-table">
          <thead><tr>${mat.designParams.headers.map(h => `<th>${h}</th>`).join('')}</tr></thead>
          <tbody>${mat.designParams.rows.map(row =>
            `<tr>${row.map((cell, i) => i === 0 ? `<td class="val">${cell}</td>` : `<td>${cell}</td>`).join('')}</tr>`
          ).join('')}</tbody>
        </table>
      </div>
  ...
  if (mat.tradeoffMatrix && mat.tradeoffMatrix.relations) {
    html += `<div class="mat-block">
      ...
      <div style="display:flex;flex-direction:column;gap:8px;">`;
    mat.tradeoffMatrix.relations.forEach(rel => {
      html += `
  ...
  if (mat.newsStructure && mat.newsStructure.length) {
    html += `<div class="mat-block">
      ...
      <div style="display:flex;flex-direction:column;gap:6px;">`;
    mat.newsStructure.forEach(part => {
      html += `
  ...
  if (mat.creationTasks && mat.creationTasks.length) {
    html += `<div class="mat-block">
      ...
      <div style="display:flex;flex-direction:column;gap:8px;">`;
    mat.creationTasks.forEach(task => {
      html += `
  ...
  if (mat.rubric && mat.rubric.rows) {
    html += `<div class="mat-block">
      ...
      <div style="overflow-x:auto;">
        <table class="mat-table">
          <thead><tr>${mat.rubric.headers.map(h => `<th>${h}</th>`).join('')}</tr></thead>
          <tbody>${mat.rubric.rows.map(row =>
            `<tr>${row.map((cell, i) => i === 0 ? `<td class="val">${cell}</td>` : `<td>${cell}</td>`).join('')}</tr>`
          ).join('')}</tbody>
        </table>
      </div>
  ...
  if (mat.humanVsAI && mat.humanVsAI.rows) {
    html += `<div class="mat-block">
      ...
      <div style="overflow-x:auto;">
        <table class="mat-table">
          <thead><tr>${mat.humanVsAI.headers.map(h => `<th>${h}</th>`).join('')}</tr></thead>
          <tbody>${mat.humanVsAI.rows.map(row =>
            `<tr>${row.map((cell, i) => i === 0 ? `<td class="val">${cell}</td>` : `<td>${cell}</td>`).join('')}</tr>`
          ).join('')}</tbody>
        </table>
      </div>
